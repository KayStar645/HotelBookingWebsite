        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PercentMax = table.Column<double>(type: "float", nullable: true),
                    Percent = table.Column<double>(type: "float", nullable: true),
                    PriceMax = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomPromotions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomPromotions_Promotions_PromotionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomPromotions_PromotionId",
