...
{
	public sealed class InternalCodeAttribute<TEntity, TRquest> : ValidationAttribute
	where TEntity : AuditableEntity, IInternalCode
		where TRquest : BaseRQ
	{
		...
		protected override ValidationResult IsValid(object value, ValidationContext validationContext)
		{
			...
			var isDuplicate = query.Any(s => s.InternalCode == value.ToString());
